      ...
      <div id='home-section' className="w-full min-h-screen flex flex-col items-center justify-start overflow-hidden">
        ...
        <div className="w-full h-[40vh] flex flex-col items-center justify-center bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-32 text-center">
          ...
          <div className="flex justify-center gap-4">
            <button className="bg-white text-indigo-600 font-semibold px-6 py-3 rounded-lg shadow-lg hover:bg-gray-100 hover:scale-105 duration-200
              transition-all cursor-pointer"
              onClick={() => router.push('/closet')}
            >
              Upload Clothes
            </button>
            <button className="bg-indigo-700 text-white font-semibold px-6 py-3 rounded-lg shadow-lg hover:bg-indigo-800 hover:scale-105 duration-200
              transition-all cursor-pointer"
        ...
        <div className="py-20 text-center min-h-[70vh]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
            ...
            <div className="presentation-card p-6 bg-white rounded-xl shadow-lg">
              ...
              <h3 className="text-2xl font-semibold mb-2">Mix & Match</h3>
            ...
            <div className="presentation-card p-6 bg-white rounded-xl shadow-lg">
              ...
              <h3 className="text-2xl font-semibold mb-2">Try in 3D</h3>
